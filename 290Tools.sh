...
cowsay -f eyes "Ariel Sandy Permana" | lolcat
figlet -f slant "290 Tools" | lolcat

echo -b "_____________________________________________________________" | lolcat
echo -b "TYPE      : 1L1R Tools $green " |lolcat
echo -b "VERSION   : V.4 " | lolcat
echo -b "TOTALS    : 290 TOOLS " | lolcat
echo -b "AUTHOR    : Ariel Sandy Permana $green " |lolcat
echo -b "ASSOCIATE : 1L1R TERMUX CODING$green " |lolcat
echo -b "ASSOCIATE : 1 L1R TERMUX TUTORIAL $green " |lolcat
echo -b "ASSOCIATE : 1L1R TERMUX CODING TUTORIAL$green " |lolcat
echo -b "NOTES     : JELAJAHI SETIAP TOOLS DENGAN BAIK " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
sleep 1
echo -b $green"[#]> Ariel Sandy Permana Your System" |lolcat

echo -b $green"[#]> See you Again SCRIPTKIDDIESðŸ˜Ž :)..." |lolcat
cowsay -f eyes "Ariel Sandy Permana" | lolcat
figlet -f slant "Ariel Sandy Permana" | lolcat
sleep 1
exit
}
...
echo ""
echo -e $b "999. install Dark Fb${enda}";
echo -e "============================" | lolcat
...
999) git clone https://github.com/arielpersija69/DarkfbV5
cd DarkfbV5
python2 hg.py
...
0) echo "Sorry, Your choices it's not already [T4T]"
esac
done
done
